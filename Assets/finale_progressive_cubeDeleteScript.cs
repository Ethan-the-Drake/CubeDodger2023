...
public class finale_progressive_cubeDeleteScript : MonoBehaviour
{
	finale_ProgressiveSceneHandlerScript scenehandlescript;
	...
	void Start ()
	{
		...
		scenehandlescript = GameObject.Find ("SceneHandler").GetComponent<finale_ProgressiveSceneHandlerScript>();
