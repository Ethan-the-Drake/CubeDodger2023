...
public class cubeDeleteScript : MonoBehaviour
{
	...
	public bool isBallCube;// Enable this on ball references.
	...
	void Start ()
	{
		...
		//ettingsScript = GameObject.Find ("settingsHolder").GetComponent<settingsScript> ();
		...
		if (isBallCube) {
			...
			if (settingsScript.modifierAirdrop == false) {
				...
				//cubeRB.AddForce (Random.Range (-5, 5), 0, 0);
			}
		}
